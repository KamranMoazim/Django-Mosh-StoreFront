    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member_ship', models.CharField(choices=[('S', 'Silver'), ('G', 'Gold'), ('B', 'Bronze')], default='B', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('member_ship', models.CharField(choices=[('F', 'Fail'), ('P', 'Pending'), ('C', 'Complete')], default='P', max_length=1)),
